...
var logger = require('../utils/pino-logger')

var customStorage = require('../../../libs/custom-mongo-storage-plugin/index');
var server = null;
...
module.exports = {
    ...
    init: function (httpServer, userSettings) {
        ...
        customStorage.init(userSettings);
        return;
    },
    /**
    ...
    saveAuditLog: async function (logRecord) {
        await customStorage.saveAuditLogs(logRecord);
    },

    saveRuntimeLog: async function (logRecord) {
        // TODO: add call to save runtime logs to message queue    
        await customStorage.saveRuntimeLogs(logRecord);
    },

    saveNodeMetrics: async function (logRecord) {
        await customStorage.saveNodeMetrics(logRecord);
    },

    updateRuntimeLogsSummary: async function (filter, logRecord, options) {
        await customStorage.updateRuntimeLogsSummary(filter, logRecord, options)
    },
    ...
    /**
     * The express application for HTTP Internal
     * @type ExpressApplication
     * @memberof node-red
     */
    get httpInternalApp() { return runtime.httpInternalApp },
