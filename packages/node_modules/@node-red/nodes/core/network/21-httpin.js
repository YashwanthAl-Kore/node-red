        ...
        if (RED.settings.httpNodeRoot !== false) {
            ...
            this.callback = function(req,res) {
                ...
                if (node.method.match(/^(post|delete|put|options|patch)$/)) {
                    node.receive({_msgid:msgid,req:req,res:createResponseWrapper(node,res),payload:req.body});
                } else if (node.method == "get") {
                    node.receive({_msgid:msgid,req:req,res:createResponseWrapper(node,res),payload:req.query});
                } else {
                    node.receive({_msgid:msgid,req:req,res:createResponseWrapper(node,res)});
                }
