...
#red-ui-header {
    ...
    #red-ui-header-button-draft {
        padding: 4px 12px;
        &.disabled {
            cursor: default;
            background: var(--red-ui-deploy-button-background-disabled);
            color: var(--red-ui-deploy-button-color-disabled);
            >.red-ui-draft-button-content {
                opacity: 0.3;
            }
            &+#red-ui-header-button-draft-delete {
                background: var(--red-ui-deploy-button-background-disabled) !important;
            }
            &+ #red-ui-header-button-draft-delete:hover {
                background: var(--red-ui-deploy-button-background-disabled-hover);
            }
        }
        .red-ui-deploy-button-content>img {
    ...
    ul#red-ui-header-button-draft-options-submenu {
        width: 300px !important;
        li a {
            padding: 10px 30px;
            color: var(--red-ui-header-menu-heading-color);
