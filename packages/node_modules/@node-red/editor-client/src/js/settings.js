...
RED.settings = (function () {
    ...
    var init = function (options, done) {
        ...
        const showDiff = url.searchParams.get("showDiff");
        ...
        if (access_token) {
          RED.settings.set("auth-tokens", { access_token });
          window.location.search = `?appId=${appId}&showDiff=${showDiff}&appName=${appName}&appType=${appType}`;
        }
