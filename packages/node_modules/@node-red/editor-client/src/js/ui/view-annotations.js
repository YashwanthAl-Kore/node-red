RED.view.annotations = (function() {
    ...
    function init() {
        RED.hooks.add("viewRedrawNode.annotations", function(evt) {
            function addRectBorder(){
                var rect = evt.el.children[0];
                rect.setAttribute('stroke', 'black');
                rect.setAttribute('strokeWidth', '4 !important');
                rect.setAttribute('stroke-dasharray', '4, 2');
            }
            function removeRectBorder(){
                var rect = evt.el.children[0];
                rect.removeAttribute('stroke');
                rect.removeAttribute('stroke-dasharray');
            }
            let showRect = evt.node.isDraft || evt.node.changed || evt.node.moved;
            if(showRect){
                addRectBorder();
            }else{
                removeRectBorder();
