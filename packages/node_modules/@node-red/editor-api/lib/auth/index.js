...
function init(_settings,storage) {
    ...
    if (settings.adminAuth) {
        ...
        Users.init(mergedAdminAuth,storage);
...
// async function checkTenantAndToken(req,res,next) {
//     console.log(req.headers.authorization);
//     if (!req.headers.authorization || !req.headers.account_id) {
//         return res.status(401).send('Missing authorization or account_id in header');
//     }
//     const account_id = req.headers.account_id;
//     const tenant = await TenantConfig.findById(account_id);
//     if (req.headers.authorization === process.env.ACCESS_TOKEN && tenant.accountId === account_id) {
//         next();
//     } else {
...
async function checkToken(req,res,next) {
    ...
    if (authToken === process.env.ACCESS_TOKEN) {
        ...
        req.admin = jwt.decode(authToken);
        next();
    } else {
        res.status(401).send('Unauthorized');
    }
...
module.exports = {
    ...
    getToken: getToken,
    //checkTenantAndToken: checkTenantAndToken,
