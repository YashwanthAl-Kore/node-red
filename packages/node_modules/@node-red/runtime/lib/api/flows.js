...
var api = module.exports = {
    ...
    */
    getFlows: async function(opts) {
        ...
        const flows = await runtime.flows.getFlows(opts.tenantConfigId, opts.appId, opts.appType)
        return flows;
    },
    /**
    ...
    */
    setFlows: async function(opts) {
        return mutex.runExclusive(async function() {
            runtime.log.audit({event: "flows.set",type:"full"}, opts.req);
            return runtime.flows.updateFlows(opts);
        })
    },
